...
def check(email):
    url = "https://fc1ag5dxyg.execute-api.ap-south-1.amazonaws.com/login?email="+email
...
def requested():
    ...
    print(address)
    url = "https://g9tt2q1wpj.execute-api.ap-south-1.amazonaws.com/getpersonsgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
